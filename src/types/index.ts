...
export enum AvailableIntentsEventsEnum {
    ...
    OPEN_FORUMS_EVENT = 'OPEN_FORUMS_EVENT',
...
export const WsEventType: { [key: string]: AvailableIntentsEventsEnum } = {
    ...
    //  ======= GUILD_MESSAGES ====== (1 << 9)
    MESSAGE_CREATE: AvailableIntentsEventsEnum.GUILD_MESSAGES, // 机器人收到频道消息被创建
    MESSAGE_DELETE: AvailableIntentsEventsEnum.GUILD_MESSAGES, // 机器人收到频道消息被删除
    ...
    OPEN_FORUM_THREAD_CREATE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户创建主题时
    OPEN_FORUM_THREAD_UPDATE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户更新主题时
    OPEN_FORUM_THREAD_DELETE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户删除主题时
    OPEN_FORUM_POST_CREATE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户创建帖子时
    OPEN_FORUM_POST_DELETE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户删除帖子时
    OPEN_FORUM_REPLY_CREATE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户回复评论时
    OPEN_FORUM_REPLY_DELETE: AvailableIntentsEventsEnum.OPEN_FORUMS_EVENT, // 当用户删除评论时

    //  ======= AUDIO_OR_LIVE_CHANNEL_MEMBER ====== (1 << 19)
    AUDIO_OR_LIVE_CHANNEL_MEMBER_ENTER: AvailableIntentsEventsEnum.AUDIO_OR_LIVE_CHANNEL_MEMBER, // 当用户进入音视频/直播子频道
    AUDIO_OR_LIVE_CHANNEL_MEMBER_EXIT: AvailableIntentsEventsEnum.AUDIO_OR_LIVE_CHANNEL_MEMBER, // 当用户离开音视频/直播子频道
    ...
    //  ======= FORUMS_EVENT ====== (1 << 28)
    FORUM_THREAD_CREATE: AvailableIntentsEventsEnum.FORUMS_EVENT, // 当用户创建主题时
    FORUM_THREAD_UPDATE: AvailableIntentsEventsEnum.FORUMS_EVENT, // 当用户更新主题时
    FORUM_THREAD_DELETE: AvailableIntentsEventsEnum.FORUMS_EVENT, // 当用户删除主题时
    FORUM_POST_CREATE: AvailableIntentsEventsEnum.FORUMS_EVENT, // 当用户创建帖子时
    FORUM_POST_DELETE: AvailableIntentsEventsEnum.FORUMS_EVENT, // 当用户删除帖子时
    ...
    AT_MESSAGE_CREATE: AvailableIntentsEventsEnum.PUBLIC_GUILD_MESSAGES, // 当收到@机器人的消息时
...
export const WebsocketCloseReason = [
    { code: 4001, reason: '无效的opcode', },
    { code: 4002, reason: '无效的payload', },
    { code: 4007, reason: 'seq错误', },
    { code: 4008, reason: '发送 payload 过快，请重新连接，并遵守连接后返回的频控信息', },
    { code: 4009, reason: '连接过期，请重连', },
    { code: 4010, reason: '无效的shard', },
    { code: 4011, reason: '连接需要处理的guild过多，请进行合理分片', },
    { code: 4012, reason: '无效的version', },
    { code: 4013, reason: '无效的intent', },
    { code: 4014, reason: 'intent无权限', },
    { code: 4900, reason: '内部错误，请重连', },
    { code: 4914, reason: '机器人已下架,只允许连接沙箱环境,请断开连接,检验当前连接环境', },
    { code: 4915, reason: '机器人已封禁,不允许连接,请断开连接,申请解封后再连接', },
];
